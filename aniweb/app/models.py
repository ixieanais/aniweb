...
class EpisodesOrm(Base):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True)
    anime_name: Mapped[str | None] = mapped_column(Text)
    episode_name: Mapped[str | None] = mapped_column(Text)
    ...
    url_1080: Mapped[str | None] = mapped_column(Text)
    url_720: Mapped[str | None] = mapped_column(Text)
    url_480: Mapped[str | None] = mapped_column(Text)
    source: Mapped[str] = mapped_column(Text, nullable=False)
